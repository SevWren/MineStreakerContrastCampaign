...
class RepairRouteDecisionTests(unittest.TestCase):
    ...
    def test_sealed_cluster_routes_to_phase2(self):
        ...
        self.assertTrue(route.phase2_full_repair_hit_time_budget)
        self.assertTrue(route.decision["phase2_full_repair_hit_time_budget"])
    ...
    def test_last100_route_when_phase2_disabled(self):
        ...
        self.assertTrue(route.last100_repair_hit_time_budget)
        self.assertTrue(route.decision["last100_repair_hit_time_budget"])
