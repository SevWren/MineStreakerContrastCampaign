...
| DEMO-REQ-002 | Playback speed is config-driven and mine-count scaled | `playback_speed_contract.md`, `config_contract.md` | `playback/speed_policy.py` | `test_speed_policy.py` | `DemoConfigBuilder` | min/base/multiplier/max tests pass |
| DEMO-REQ-003 | Playback speed is not hardcoded in pygame loop | `source_modularity_standard.md` | `playback/speed_policy.py` | `test_architecture_boundaries.py` | `import_boundary_assertions.py` | no pygame+speed mixing |
